package bo.edu.uagrm.soe.mdeisv2e4.apcc.automation.core.api.config;
...
import static bo.edu.uagrm.soe.mdeisv2e4.apcc.automation.core.api.config.ApiConfigWords.API_AUTHENTICATION_TYPE;
import static bo.edu.uagrm.soe.mdeisv2e4.apcc.automation.core.api.config.ApiConfigWords.API_AUTHENTICATION_USER_TYPE;
import static bo.edu.uagrm.soe.mdeisv2e4.apcc.automation.core.api.config.ApiConfigWords.API_NAME;
import static bo.edu.uagrm.soe.mdeisv2e4.apcc.automation.core.api.config.ApiConfigWords.API_VERSION_NAME;
import static bo.edu.uagrm.soe.mdeisv2e4.apcc.automation.core.api.config.ApiConfigWords.ENVIRONMENT_NAME;
